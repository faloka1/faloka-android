package com.example.faloka_mobile.Decoration;
...
public class ListProductPaddingDecoration extends RecyclerView.ItemDecoration {
    private final static int PADDING_IN_DIPS = 8;
    private final int mPadding;

    public ListProductPaddingDecoration(@NonNull Context context) {
